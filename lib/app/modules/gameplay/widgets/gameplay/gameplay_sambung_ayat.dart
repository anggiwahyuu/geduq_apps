...
import 'package:geduq_apps/app/modules/gameplay/controllers/gameplay_sambung_ayat_controllers.dart';
...
class GameplaySambungAyat extends StatelessWidget {
  const GameplaySambungAyat({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<SambungAyatController>(
      init: SambungAyatController(),
      builder: (_) {
                            ...
                            child: Column(
                              children: [
                                ...
                                Align(
                                  ...
                                  child: main.itemsSambungAyat.isNotEmpty
                                      ? Column(
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                  ...
                                                  child: IconButton(
                                                      onPressed: () async {
                                                        await audio.playSound(
                                                            main.itemsSambungAyat[main.randomPickSambungAyat]["sound"]);
                                                      },
                                                      icon: Icon(
                                                        Icons.volume_up,
                                                        size: 18.dm,
                                                ...
                                                Flexible(
                                                  child: SizedBox(
                                                    child: Text(
                                                      main.itemsSambungAyat[main.randomPickSambungAyat]["question"],
                                                  ...
                                                  return Card(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () {
                                                        ...
                                                        _.setAnswer(main.optionSambungAyat[index]);
                                                        _.setIsChoose(true);
                                                      },
                                                    ),
                                                  );
                                              ...
                                              child: Align(
                                                ...
                                                child: Card(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      if (_.answer ==
                                                          main.itemsSambungAyat[main.randomPickSambungAyat]
                                                              ["correct_answer"]) {
