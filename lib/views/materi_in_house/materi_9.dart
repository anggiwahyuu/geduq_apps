...
class MateriNine extends StatelessWidget {
  MateriNine({super.key});
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                            ...
                            children: [
                              Transform.flip(
                                ...
                                child: IconButton(
                                    onPressed: () async {
                                      await audioController
                                          .playSound("sounds/basmallah.mp3");
                                    },
                                    icon: Icon(
                                      Icons.volume_up,
                                      size: 18.dm,
                        ...
                        Obx(() {
                          if (ayatMateriController.itemsAlIkhlas.isNotEmpty) {
                            final items = ayatMateriController.itemsAlIkhlas[0];
                    ...
                    Align(
                      ...
                      child: Card(
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            controller.materiNineIsOpen.value = true;
                            Get.back();
                          },
                        ),
                      ),
