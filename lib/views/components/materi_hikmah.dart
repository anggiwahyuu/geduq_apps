              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        materiController.itemHikmah[materiController.randomPickHikmah]["title"],
                      ...
                      Flexible(
                        child: ListView.builder(
                          ...
                          shrinkWrap: true,
                          itemCount: materiController.itemHikmah[materiController.randomPickHikmah]["content"].length,
                          itemBuilder: (context, index) {
                            return Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: SizedBox(
                                    child: Text(materiController.itemHikmah[materiController.randomPickHikmah]["content"][index]),
                                  )
                                )
                              ],
                            );
