...
class GameplayTebakArtiSurah extends StatelessWidget {
  ...
  final TebakArtiController tebakArtiController =
      Get.put(TebakArtiController());
                                      ...
                                      (index) {
                                        return Card(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () {
                                              selectedIndex.value = index;
                                              answer.value = tebakArtiController
                                                  .option[index];
                                              isChoose.value = true;
                                            },
                                          ),
                        ...
                        Card(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                controller.stageTebakArtiDone
                                    .add(tebakArtiController.randomPick);
