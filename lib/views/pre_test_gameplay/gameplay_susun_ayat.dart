...
class GameplaySusunAyat extends StatelessWidget {
  ...
  final SusunAyatController susunAyatController =
      Get.put(SusunAyatController());
                              ...
                              children: [
                                ...
                                Wrap(
                                    ...
                                    children: List.generate(
                                      susunAyatController.option.length,
                                      (index) {
                                        return Card(
                                          elevation: 5,
                                          child: InkWell(
                        ...
                        Card(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                controller.stageSusunAyatDone
                                    .add(susunAyatController.randomPick);
