...
import 'package:geduq_apps/controllers/gameplay_arti_ayat_controller.dart';
...
class GameplayArtiAyat extends StatelessWidget {
  ...
  final TebakArtiAyatController artiAyatController = Get.put(TebakArtiAyatController());
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      artiAyatController.items.isNotEmpty
                      ? Align(
                        alignment: Alignment.topLeft,
                        child: Text(artiAyatController.items[artiAyatController.randomPick]["naration"], style: TextStyle(fontSize: 7.sp),),
                      )
                      : Container(),
                            
                      Align(
                        alignment: Alignment.topRight,
                        child: artiAyatController.items.isNotEmpty
                        ? Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                artiAyatController.items[artiAyatController.randomPick]["sound"] == ""
                                ? Container()
                                : Transform.flip(
                                  flipX: true,
                                  child: IconButton(
                                    onPressed: () async {
                                      await audioController.playSound(artiAyatController.items[artiAyatController.randomPick]["sound"]);
                                    }, 
                                    icon: Icon(
                                      Icons.volume_up,
                                      size: 18.dm,
                                ...
                                Flexible(
                                  child: SizedBox(
                                    child: Text(
                                      artiAyatController.items[artiAyatController.randomPick]["question"], 
                                      style: TextStyle(
                                        fontSize: 12.sp,
                            ...
                            Align(
                              ...
                              child: Wrap(
                                spacing: 3.0.w,
                                runSpacing: 4.0.h,
                                children: List.generate(artiAyatController.option.length, (index) {
                                  ...
                                  return Card(
                                    ...
                                    child: InkWell(
                                        child: Container(
                                          ...
                                          child: Text(
                                            artiAyatController.option[index],
                                            style: TextStyle(
                                              fontSize: 6.sp,
                                              fontWeight: FontWeight.bold,
                                        ...
                                        onTap: () {
                                          ...
                                          answer.value = artiAyatController.option[index];
                                          isChoose.value = true;
                                        },
                                      ),
                                    );
                              ...
                              child: Align(
                                ...
                                child: Card(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      if(answer == artiAyatController.items[artiAyatController.randomPick]["correct_answer"]) {
                        ...
                        Card(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              controller.stageSambungAyatDone.add(artiAyatController.randomPick);
