...
class GameplayArtiAyat extends StatelessWidget {
  ...
  final TebakArtiAyatController artiAyatController =
      Get.put(TebakArtiAyatController());
                  ...
                  children: [
                    ...
                    artiAyatController.items.isNotEmpty
                        ? Align(
                            ...
                            child: Text(
                              artiAyatController
                                      .items[artiAyatController.randomPick]
                                  ["naration"],
                                ...
                                Align(
                                  ...
                                  child: Wrap(
                                      ...
                                      children: List.generate(
                                        artiAyatController.option.length,
                                        (index) {
                                          return Card(
                                            elevation: 5,
                                            child: InkWell(
                        ...
                        Card(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                controller.stageSambungAyatDone
                                    .add(artiAyatController.randomPick);
