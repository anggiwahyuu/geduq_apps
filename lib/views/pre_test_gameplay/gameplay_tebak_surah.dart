...
class GameplayTebakSurah extends StatelessWidget {
  ...
  final TebakSurahController tebakSurahController = Get.put(TebakSurahController());
                  ...
                  child: Column(
                    children: [
                      ...
                      Align(
                        ...
                        child: Text("Apa nama surat dari potongan ayat di bawah ini?", style: TextStyle(fontSize: 7.sp),),
                      ),
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Transform.flip(
                                  ...
                                  child: IconButton(
                                    onPressed: () async {
                                      await audioController.playSound(tebakSurahController.items[tebakSurahController.randomPick]["sound"]);
                                    },
                                    icon: Icon(
                                      Icons.volume_up,
                                      size: 18.dm,
                                ...
                                Flexible(
                                  child: SizedBox(
                                    child: Text(
                                      tebakSurahController.items[tebakSurahController.randomPick]["question"], 
                                      style: TextStyle(
                                        fontSize: 12.sp, 
                            ...
                            Align(
                              ...
                              child: Wrap(
                                spacing: 3.0.w,
                                runSpacing: 4.0.h,
                                children: List.generate(tebakSurahController.option.length, (index) {
                                  ...
                                  return Card(
                                    ...
                                    child: InkWell(
                                        child: Container(
                                          ...
                                          child: Text(
                                            tebakSurahController.option[index],
                                            style: TextStyle(
                                              fontSize: 7.sp,
                                              fontWeight: FontWeight.bold,
                                        ...
                                        onTap: () {
                                          ...
                                          answer.value = tebakSurahController.option[index];
                                          isChoose.value = true;
                                        },
                                      ),
                                    );
                              ...
                              child: Align(
                                ...
                                child: Card(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      if(answer == tebakSurahController.items[tebakSurahController.randomPick]["correct_answer"]) {
                        ...
                        Card(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              controller.stageTebakSurahDone.add(tebakSurahController.randomPick);
