...
class GameplaySambungAyat extends StatelessWidget {
  ...
  final SambungAyatController sambungAyatController =
      Get.put(SambungAyatController());
                              ...
                              children: [
                                ...
                                Wrap(
                                    ...
                                    children: List.generate(
                                      sambungAyatController.option.length,
                                      (index) {
                                        return Card(
                                          elevation: 5,
                                          child: InkWell(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                controller.stageSambungAyatDone
                                    .add(sambungAyatController.randomPick);
