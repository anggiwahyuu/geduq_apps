...
import 'package:geduq_apps/controllers/gameplay_sambung_ayat_controllers.dart';
...
class GameplaySambungAyat extends StatelessWidget {
  GameplaySambungAyat({super.key});
  ...
  final SambungAyatController sambungAyatController = Get.put(SambungAyatController());
                  ...
                  child: Column(
                    children: [
                      ...
                      Align(
                        ...
                        child: Text("Sambung ayat yuk!", style: TextStyle(fontSize: 7.sp),),
                      ),
                            
                      Align(
                        alignment: Alignment.topRight,
                        child: sambungAyatController.items.isNotEmpty
                        ? Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Transform.flip(
                                  ...
                                  child: IconButton(
                                    onPressed: () async {
                                      await audioController.playSound(sambungAyatController.items[sambungAyatController.randomPick]["sound"]);
                                    }, 
                                    icon: Icon(
                                      Icons.volume_up,
                                      size: 18.dm,
                                ...
                                Flexible(
                                  child: SizedBox(
                                    child: Text(
                                      sambungAyatController.items[sambungAyatController.randomPick]["question"], 
                                      style: TextStyle(
                                        fontSize: 12.sp, 
                            ...
                            Wrap(
                              spacing: 3.0.w,
                              runSpacing: 4.0.h,
                              children: List.generate(sambungAyatController.option.length, (index) {
                                ...
                                return Card(
                                  ...
                                  child: InkWell(
                                      child: Container(
                                        ...
                                        child: Text(
                                          sambungAyatController.option[index],
                                          style: TextStyle(
                                            fontSize: 8.sp,
                                            fontWeight: FontWeight.bold,
                                      ...
                                      onTap: () {
                                        ...
                                        answer.value = sambungAyatController.option[index];
                                        isChoose.value = true;
                                      },
                                    ),
                                  );
                              ...
                              child: Align(
                                ...
                                child: Card(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      if(answer == sambungAyatController.items[sambungAyatController.randomPick]["correct_answer"]) {
                        ...
                        Card(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              controller.stageSambungAyatDone.add(sambungAyatController.randomPick);
